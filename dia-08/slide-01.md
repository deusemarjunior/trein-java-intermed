...
```mermaid
flowchart TD
    D1["<b>Dia 1 — Fundamentos</b><br/>☕ Records, Sealed, Streams"]
    D2["<b>Dia 2 — Persistência/REST</b><br/>🗄️ JPA, Controllers, DTOs"]
    D3["<b>Dia 3 — Qualidade</b><br/>🏛️ Clean Code, Hexagonal"]
    ...
    style D6 fill:#4a90d9,color:#fff
    style D7 fill:#4a90d9,color:#fff
    style D8 fill:#1dd1a1,color:#fff,stroke:#10ac84
```
