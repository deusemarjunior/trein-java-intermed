...
```mermaid
gantt
    title Agenda - Dia 3: Arquitetura e Design
    dateFormat HH:mm
    axisFormat %H:%M
    
    section Manhã
    Apresentação e Setup           :09:00, 15m
    Princípios SOLID               :09:15, 90m
    Coffee Break                   :10:45, 15m
    Design Patterns                :11:00, 90m
    
    section Almoço
    Almoço                         :12:30, 60m
    
    section Tarde
    Domain-Driven Design           :13:30, 60m
    Arquitetura em Camadas         :14:30, 60m
    Coffee Break                   :15:30, 15m
    Exercícios Práticos            :15:45, 60m
    Review e Q&A                   :16:45, 15m
```
...
```mermaid
pie title "Distribuição do Tempo (5h)"
    "Teoria e Demonstrações" : 40
